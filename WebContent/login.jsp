	...
	<div id="logreg-forms">
		...
		<form
			...
			<input type="text" name="userAccount" class="form-control" maxlength="16"
				...
				name="userPassword" class="form-control" maxlength="16" placeholder="密碼"
				value="<%=(generalUserVO == null) ? "" : generalUserVO.getUserPassword()%>"
				required autofocus> <input type="password"
				name="user-repeatpass"  maxlength="16" class="form-control" placeholder="再次確認密碼"
				value="" required autofocus> <input type="text"
				name="userName" maxlength="10" class="form-control" placeholder="姓名"
