	...
	<div id="logreg-forms">
		<form class="form-signin" method="post"
			...
			<input type="text" name="inputAccount" class="form-control"
				placeholder="帳號或信箱" required="required" autofocus> <input
				type="password" name="inputPassword" class="form-control"
				placeholder="請輸入密碼" required="required"> <input type="radio"
