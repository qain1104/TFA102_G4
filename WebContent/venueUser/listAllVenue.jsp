		...
		<c:forEach var="venueVO" items="${list}" begin="<%=pageIndex%>"
			...
			<tbody>
				<tr>
					...
					<th scope="row">${venueVO.venuePrice}</th>
					<th scope="row">${venueVO.venueAccommodate}</th>
					...
					<th><FORM METHOD="post"
						...
						<input type="submit" class="btn btn-success" value="租借">
					...
					<th><FORM METHOD="post"
						ACTION="<%=request.getContextPath()%>/rental_list/rental_list.do"
						style="margin-bottom: 0px;">
						<input type="submit" class="btn btn-success" value="追蹤">
						<input type="hidden" name="venueSN" value="${venueVO.venueSN}">
