...
<body>
	...
	<FORM METHOD="post"
		...
		<div class="container mb-3 mt-5"align="center">
			<h3>請選擇不開放的日期</h3>
			<input type="text" class="form-control date"
				placeholder="Pick the multiple dates" style="width: 50%"
				name="venueDate">
		</div>

		<div align="center">
		<input type="hidden" name="venueSN" value="${param.venueSN}">
			<input type="hidden" name="action" value="insertNopDate"> <input
				type="submit" value="下一步" class="btn btn-success">
		</div>
	</FORM>
