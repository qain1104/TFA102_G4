...
<%
  CorpUserVO  corpUserVO = (CorpUserVO) request.getAttribute("corpUserVO"); //CorpUserServlet.java (Concroller) 存入req的corpUserVO物件 (包括幫忙取出的corpUserVO, 也包括輸入資料錯誤時的corpUserVO物件)
%>

<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
<title>企業會員資料修改 - update_corpUser_input.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>企業會員資料修改 - update_corpUser_input.jsp</h3>
...
<table>
	<tr>
		<td>企業會員編號:<font color=red><b>*</b></font></td>
...
<input type="hidden" name="corpPassword" value="<%=corpUserVO.getCorpPassword()%>">   <%--如果使用者沒選改密碼應該要送這個出去 --%>
