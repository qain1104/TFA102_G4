...
<%
	VenueWatchListVO venueWatchListVO = (VenueWatchListVO) request.getAttribute("venueWatchListVO"); //EmpServlet.java (Concroller) 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>
		...
		<tr>
			<td>
				...
				<button type="button" class="btn btn-success btn-lg "
					onclick="location.href='<%=request.getContextPath()%>/venue_watchlist/select_page.jsp'">回到首頁</button>
			</td>
		</tr>
	</table>
	...
	<FORM METHOD="post"
					...
					<div class="col col-lg-4">
						<div class="form-floating" col-lg-2>
							<input type="text" class="form-control" placeholder="text"
								...
								value="<%=venueWatchListVO.getVenueSN()%>"> <label
					...
					<div class="col col-lg-4">
						<div class="form-floating" col-lg-2>
							<input type="text" class="form-control" placeholder="text"
								...
								value="<%=venueWatchListVO.getUserId()%>"> <label
		...
		<div align="center">
			<input type="hidden" name="action" value="update"> <input
				...
				value="<%=venueWatchListVO.getVenueWatchListSN()%>"> <input
