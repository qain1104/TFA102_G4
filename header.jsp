		...
		<div
			...
			<div class="navbar align-self-center d-flex">
				...
				<a class="nav-icon d-none d-lg-inline" href="#"
					...
					<span class="position-absolute top-0 left-100 translate-middle badge rounded-pill bg-light text-dark">${headerCartList}</span>
...
<div class="modal fade bg-white" id="templatemo_search" tabindex="-1"
	...
	<div class="modal-dialog modal-lg" role="document">
		...
		<form action="<%=request.getContextPath()%>/shopping/SportifyShop.do" method="POST"
