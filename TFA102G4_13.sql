...
createdTime 	TIMESTAMP NOT NULL COMMENT '帳號建立時間',
...
productOnsale TIMESTAMP NOT NULL COMMENT '上架日期' ,
...
CREATE TABLE MORDER(
    ...
    purchaseDate 	TIMESTAMP NOT NULL COMMENT '購買日期',
...
venueDate       TIMESTAMP NOT NULL COMMENT '場地不開放日期',	
...
rentalDate      TIMESTAMP NOT NULL COMMENT '租借日期',	
...
articleContent BLOB NOT NULL COMMENT '文章內容',
articlePop INT NOT NULL COMMENT '文章人氣',
articleLikes INT NOT NULL COMMENT '按讚數',
articleDate TIMESTAMP NOT NULL COMMENT '上架日期',
articleUpDate TIMESTAMP COMMENT '編輯日期',
...
INSERT INTO ARTICLE(userId,articleClass,articleType,articleTitle,articleContent,articlePop,articleLikes,articleDate,articleUpDate,articleStatus)
...
articleLikeSN INT NOT NULL AUTO_INCREMENT COMMENT '文章按讚編號',
articleSN INT NOT NULL COMMENT '文章編號',
userId INT NOT NULL COMMENT '會員編號',
CONSTRAINT ARTICLE_LIKE_articleLikeSN_PK PRIMARY KEY (articleLikeSN),
...
articleSN INT NOT NULL COMMENT '文章編號',
userId INT NOT NULL COMMENT '會員編號' ,
replyContent BLOB NOT NULL COMMENT '回覆內容',
replyLikes INT NOT NULL COMMENT '按讚數',
replyDate TIMESTAMP NOT NULL COMMENT '上架日期',
replyUpDate TIMESTAMP COMMENT '編輯日期',
...
INSERT INTO REPLY(articleSN,userId,replyContent,replyLikes,replyDate,replyUpDate,replyStatus)
...
replyLikeSN INT NOT NULL AUTO_INCREMENT COMMENT '回覆按讚編號',
replySN INT NOT NULL COMMENT '文章回覆編號',
userId INT NOT NULL COMMENT '會員編號',
CONSTRAINT REPLY_LIKE_replyLikeSN_PK PRIMARY KEY (replyLikeSN),
...
reportDate TIMESTAMP NOT NULL COMMENT '檢舉時間',
reportStatus INT(1) NOT NULL COMMENT '檢舉狀態',
managerId INT COMMENT '後臺管理者',
reportAuditDate TIMESTAMP COMMENT '檢舉審核時間',
...
exerciseTime TIMESTAMP NOT NULL COMMENT '運動時間',
numberUpLimit INT NOT NULL COMMENT '人數上限',
numberLowLimit INT NOT NULL COMMENT '人數下限',
registTime TIMESTAMP NOT NULL COMMENT '報名時間',
registTimeEnd TIMESTAMP NOT NULL COMMENT '報名截止時間',
issueDATE TIMESTAMP NOT NULL COMMENT '發起時間',
...
CREATE TABLE SPORT_NEWS(
	...
	newsDate	TIMESTAMP NOT NULL COMMENT '新聞日期',
